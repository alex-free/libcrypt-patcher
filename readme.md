# [alex-free.github.io](alex-free.github.io)

# LibCrypt Patcher

This patcher is capable of detecting and patching **222 different PSX game discs containing LibCrypt protection**. After using this patcher on a supported LibCrypt protected PSX disc image you can then:

*   Burn a backup CD-R that works on all soft-mods and hard-mods (even non-stealth mod-chips).

*   Burn a backup CD-R using a CD burner that doesn't support buring invalid sub channel data (many older burners can't do this, which is required for normally using the traditional CloneCD/SBI method).
...
*   Use the disc image in an emulator without needing SBI files. No $ Emu seems to have some problems with some of the patches (i.e. Dino Crisis (Europe)), while DuckStation works fine if you disable the require SBI file advanced setting option. Please note that due to a bug in DuckStation, you must boot a game without LibCrypt protection first. Then while the game is running drag and drop the patched LibCrypt disc image .cue file into the window and select reset.
...
| [GitHub](https://github.com/alex-free/libcrypt-patcher) | [Homepage](https://alex-free.github.io/libcrypt-patcher) |
...
[Ape Escape - La Invasion de los Monos (Spain)](http://redump.org/disc/26604/)
...
[Disney Fais Ton Histoire! - Mulan (France)](http://redump.org/disc/24278/)
...
[Disney's Story Studio - Mulan (Europe)](http://redump.org/disc/6887/)

[Disney's Tarzan (Europe)](http://redump.org/disc/29818/)

[Disney's Tarzan (Netherlands)](http://redump.org/disc/27067/)
...
[F1 2000 (Europe) (En,Fr,De,Nl)](http://redump.org/disc/6867/)
...
[Italian Job, The (Europe)](http://redump.org/disc/617/)

[Italian Job, The (Fr,De,Es)](http://redump.org/disc/5819/)

[Italian Job, The (Italy)](http://redump.org/disc/47605/)
...
[Spyro - Year of the Dragon (Europe) (En,Fr,De,Es,It) (v1.0)](http://redump.org/disc/492/)
...
Massive thankyou to Icarus/Paradox for releasing the PPF source under open terms:
 ...
 `Feel free to use this source in and for your own programs.`
 ...
 They released proper Spyro - Year of the Dragon (Europe) (En,Fr,De,Es,It) (v1.0), Spyro - Year of the Dragon (Europe) (En,Fr,De,Es,It) (v1.1), and Sydney 2000 (Europe) LibCrypt patches as well as some interesting info on patching LibCrypt.
